javascript: (function() {
  ...
  .incorrect-ego-bookmarklet {
    ...
    function openBlooketGUI() {
        window.open("https://05konz.github.io/Blooket-Cheats/", "_blank");
      }
      ...
      blooketHacksButton.addEventListener("click", () => {
        const popupContent = `
          ...
          <button id="egoBlooketUI" data-text="by @05konz, AN INCREDIBLE GUI." class="EgoMenuButton">Blooket GUI</button>
        ...
        egoBlooketUIButton.addEventListener("click", openBlooketGUI);
      });
